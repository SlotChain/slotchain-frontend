...
const steps: Step[] = [
  {
    ...
    description:
      'Link your crypto wallet in seconds. We support MetaMask for now.',
  },
  {
    step: '02',
    title: 'Set Your Availability',
    description:
      'Configure your schedule, set your rates in crypto, and create your booking page.',
  },
  {
    step: '03',
    title: 'Share & Get Paid',
    description:
      'Share your link and receive instant crypto payments when clients book with you.',
  },
];
