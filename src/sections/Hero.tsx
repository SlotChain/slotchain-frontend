        ...
        <div className="text-center mb-16 relative">
          ...
          <div className="relative">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-800/50 backdrop-blur-sm border border-cyan-500/20 rounded-full mb-6">
              ...
              <span className="text-sm text-slate-300">Powered by blockchain technology</span>
            </div>
            ...
            <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
              The first decentralized scheduling platform where your time has real value.
              Accept crypto payments seamlessly for every booking.
            </p>
